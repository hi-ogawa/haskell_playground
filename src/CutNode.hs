...
-- TODO:
--   - calculate oldest ancestor array
--   - use the array to find out cut nodes

-- TODO:
--   - tree vertex cover
--   - algorithm using bit vector

-- TODO: take an example from train stations ?
--   - it seems not interesting since usually there's not so many cut nodes

-- TODO: explain when to compose, when to not compose and give examples
--   - compose/chaining: filter, map
--   - not: if it change types for each steps
